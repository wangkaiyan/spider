...
public class ReflectUtils {
    ...
    public static boolean hasField(String propertyName, Object object){
        try {
     ...
     * @return          属性值
     */
    public static Object getFieldValue(String propertyName, Object object) {
        try {
            Field field = object.getClass().getDeclaredField(propertyName);
